...
object SettingsReaderScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            ...
            getSuperResolutionGroup(readerPreferences = readerPref),
        )
    }
    ...
    @Composable
    private fun getSuperResolutionGroup(readerPreferences: ReaderPreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = srEnabledPref,
                    title = stringResource(MR.strings.pref_sr_enabled),
                    subtitle = stringResource(MR.strings.pref_sr_enabled_summary),
                ),
                Preference.PreferenceItem.ListPreference(
                    preference = srModelPref,

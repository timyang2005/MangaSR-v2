...
class ReaderPreferences(
    ...
    val srEnabled: Preference<Boolean> = preferenceStore.getBoolean("pref_sr_enabled", false)
    ...
    val srGrayLevels: Preference<Int> = preferenceStore.getInt("pref_sr_gray_levels", 32)

    val srDensityCorrection: Preference<Boolean> = preferenceStore.getBoolean("pref_sr_density_correction", true)
